...
// ika variabel $_SESSION['username'] sudah di-set, artinya pengguna sudah login (sesi username telah aktif), maka kode header("Location: login.php"); akan mengarahkan pengguna ke halaman login.php.
