...
?>
    ...
    <form action="" method="post">
        <div class="form-group">
            <label for="exampleFormControlTextarea1">Tanggapi Permasalahan</label>
            <textarea class="form-control" name="tanggapan" id="exampleFormControlTextarea1" rows="3"></textarea>
        </div>
        <br>
        <div class="bawah" style="display: flex; align-items: center; justify-content: space-between;">
            <input type="submit" name="tanggapi" value="Kirim" class="btn btn-primary"></input>
            <a href="index.php?p=pengaduan" style="text-decoration: none;">Balik ke menu utama</a>
        </div>
    </form>
